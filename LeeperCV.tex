...
{\bf hiDOF, South San Francisco, CA} - \emph{Senior Systems Engineer}
  ...
  \begin{compactlist}
    ...
    % \item Designed modular C++ system architecture and build system.
...
{\bf Salisbury Robotics Lab, Stanford, CA} - \emph{Graduate Researcher}
  ...
  \begin{compactlist}
    ...
    % \CVOnly{\item Implemented miniature stereo camera for robot gripper.
...
C++ (12 years) and Android Java (6 years) in large codebases (100+ engineers) featuring multi-threaded, event-driven, and multi-process designs. Also proficient in Python, Javascript, MATLAB, SQL.
\\[0.0pc]
...
Linux (expert), Mac, Windows, using version control (e.g. git) and issue tracking.
\\[0.0pc]
\textbf{Electronics -}
Circuit design/debugging; some experience with PCB layout/fabrication and embedded systems.
\\[0.0pc]
\textbf{Hardware -}
...
\hfill \textbf{2013}%
% { {\small
% %\\[0.0pc]{\bf Thesis:} Robot Telemanipulation in Unstructured Environments:
% %  Sensors, Algorithms, Interfaces.
% %\\[0.0pc]{\bf Advisor:} J. Kenneth Salisbury
% %  (Research Professor in Computer Science and Surgery)
% \\[-0.6pc]} }
%
...
\\[0.0pc]
%
{\bf Instructor:} ENGR 105, Controls, Stanford University\ResumeOnly{, 70 students}\CVOnly{, 72 students}.
  \hfill \textbf{\ResumeOnly{2015,} \CVOnly{Winter }2016}%
\\[0.0pc]
\CVOnly{
...
\BothSmall{
  ...
  HRI, March 2012, Boston, MA.}\CVOnlySmall{\\[0.4pc]}
%
\CVOnlySmall{
